...
export default function Header({
    ...
    return (
        ...
        <div className='flex w-full h-16 md:h-36 bg-white fixed top-0 left-0 z-30'>
            ...
            <div style={{ clipPath: 'polygon(90% 0%, 100% 50%, 90% 100%, 0% 100%, 0% 0%)' }} className='min-w-[120px] md:min-w-[320px] h-full bg-slate-700 flex justify-between relative z-10'>
                ...
                <div style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 100%, 50% 50%, 0% 0%)' }} className='absolute right-3 md:right-8 top-0 w-6 md:w-16 h-full bg-orange-500'></div>
            </div>
            ...
            <div className='w-full md:p-8 flex gap-2 justify-between'>

                {/* search */}
                <form action="" className='mt-[6px] md:mt-0 h-5 w-36 sm:w-44 md:w-auto md:h-9 overflow-hidden rounded-full md:rounded-md flex items-center bg-orange-100'>
                    <input type="text" placeholder='Search ...' className='text-[10px] sm:text-xs md:text-sm border md:border-2 border-orange-100 text-orange-500 placeholder:text-orange-400 rounded-l-full md:rounded-l-md bg-transparent h-full px-2 w-[120px] sm:w-60 md:w-52 lg:w-96 focus:border-orange-400 focus:outline-none' />
                    <button className='w-16 h-full bg-orange-400 flex justify-center items-center hover:bg-orange-500 transition-all duration-200'>
                        <FaSearch className='text-[10px] sm:text-xs md:text-base text-white' />
                    </button>
                </form>
